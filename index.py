...
# Eliminamos filas con datos faltantes para evitar errores en el gráfico
df = df.dropna()

# Widget: menú desplegable
# La elección del usuario queda guardada en la variable 'especie'
...
ax.hist(
    datos_filtrados["bill_length_mm"],
    bins=15,
    color="steelblue",
    edgecolor="white"
)
